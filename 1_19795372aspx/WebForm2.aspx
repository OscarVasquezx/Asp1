<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm2.aspx.cs" Inherits="_1_19795372aspx.WebForm2" %>
...
<body>
    ...
    <asp:TableRow>
        <asp:TableCell>
            <asp:Button runat="server" ID="btnSave" OnClick="btnBack_Click" Text="Save" />
